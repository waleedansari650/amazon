...
const EditProductModal = () => {
    ...
    const updateProductData = useSelector(state => state.getproductsdata.product);


    const updateData = async (product) => {
        await dispatch(updateProduct(product, updateProductData._id))
        setTimeout(async () => {
                        ...
                        <div className="modal-body relative p-4">
                            <div className="bg-white py-6 sm:py-8 lg:py-1">
                                <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
                                    ...
                                    {
                                        updateProductData && Object.keys(updateProductData).length &&
